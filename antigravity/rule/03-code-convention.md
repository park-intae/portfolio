...
## 📝 4. Git 커밋 메시지 컨벤션 (Korean Commit Message Rule)

1. **모든 Git 커밋 메시지는 한국어(Korean) 작성 표준**:
   - 커밋 메시지 제목 및 설명은 엔지니어 및 개발팀의 직관적인 이력 파악을 위해 반드시 한국어로 명확히 작성합니다.
   - 예시: `feat: 라이트/다크모드 CSS 테마 변수 유틸리티 적용 및 에러 컨트롤 하네스 구축`
