      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        >
          ...
          <div className="space-y-6">
            {experienceContent.experiences.map((exp, idx) => (
              <motion.div
                key={exp.id}
              ...
              >
                <div className="absolute -left-[5px] top-1.5 w-2 h-2 rounded-full bg-point group-hover:scale-125 transition-transform" />
        ...
        >
          ...
          <div className="space-y-6">
            {experienceContent.trainings.map((trn, idx) => (
              <motion.div
                key={trn.id}
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
